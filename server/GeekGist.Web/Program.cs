...
{
    endpoints.MapControllerRoute("home", "",  new { Controller = "Book", Action = "Index", p = 1 });
    endpoints.MapControllerRoute("page", "page/{p:int}",  new { Controller = "Book", Action = "Index" });
    endpoints.MapControllerRoute("book", "book/{id:int}",  new { Controller = "Book", Action = "Detail" });
    endpoints.MapControllerRoute("sponsor", "sponsor", new { Controller = "Home", Action = "Sponsor" });
